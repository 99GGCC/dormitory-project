...
import ServerImg from '@/components/ServerImg/index.vue'
  ...
  <div class="flex items-center">
    ...
    >
      <div class="flex-center gap-1">
        <ServerImg v-if="userStore.avatar && !avatarError" :src="userStore.avatar" :onerror="() => (avatarError = true)" class="h-[24px] w-[24px] rounded-full" />
