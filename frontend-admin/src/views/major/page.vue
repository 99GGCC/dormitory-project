...
import API from '@/api/modules/major'
...
const modalFormData = ref({ collegeId: '' })
  ...
  <PageMainFull>
    ...
    >
      ...
      <template #collegeIdSlots>
        ...
        >
          <vxe-option v-for="item in collegeOptions" :key="item.collegeId" :value="item.collegeId" :label="item.collegeName" clearable />
        </vxe-select>
      </template>
    </FormModal>
  </PageMainFull>
