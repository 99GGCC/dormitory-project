...
const props = withDefaults(
  ...
  {
    action: `${import.meta.env.VITE_APP_API_BASEURL}/common/upload/batch/image`,
    name: 'file',
    size: 2,
    max: 3,
    width: 150,
...
<template>
  <div class="upload-container">
    ...
    <ElImageViewer v-if="uploadData.imageViewerVisible" :url-list="(url as string[]).map(serverAssetsURI)" :initial-index="uploadData.dialogImageIndex" teleported @close="previewClose" />
  </div>
</template>
